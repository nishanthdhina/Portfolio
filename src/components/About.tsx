...
export default function About() {
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-black to-blue-950 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-12 items-center">
          ...
          <div className="space-y-6" data-aos="fade-up" data-aos-duration="1000">
            <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-xl overflow-hidden" data-aos="fade-up" data-aos-delay="100">
              <div className="p-8 md:p-12">
                <h3 className="text-2xl font-bold text-blue-500">Hey there! I&apos;m Nishanth</h3>
                
                <div className="space-y-4 mt-4 text-white/80 text-lg">
                  <p>
